...
- An auto-complete feature (in all my devices); support for [Android autofill API][android-autofill]
...
## Migration
LastPass supports exporting of your entries in one large JSON file. Enpass should support the importing of such a file; however, I can't tell for sure. I decided to go through all my entries and to enter them manually. My main reason was that I had a perfect opportunity to review my accounts, update passwords, and remove the ones I don't use. GDPR ["right to be forgotten"][gdpr-forget] comes handy sometimes.
