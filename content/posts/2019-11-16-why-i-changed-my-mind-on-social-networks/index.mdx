...
date: 2019-11-16
tags: socialnetwork startup influencer contentcreator leadership freedom toastmasters networking opinion
...
<div className="Image__Large">
  ...
  <figcaption>Design Thinking workshop at Hub Hub Budapest</figcaption>
</div>
...
Another issue is the Internet itself. Today it is very centralized. All the web service store our data in massive data centers owned by large companies. And we're more and more dependent on video streaming, which heavily utilizes the network infrastructure. Today, only a big company, like Amazon, could build an alternative to a platform like [YouTube][youtube]; it's just that expensive.
