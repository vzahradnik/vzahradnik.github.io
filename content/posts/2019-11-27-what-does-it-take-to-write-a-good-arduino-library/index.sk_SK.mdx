...
date: 2019-11-27
categories: arduino arduinoci library embedded testing documentation development
...
Väčšinu svojich rokov som strávil pri softvérovom vývoji, pričom som pracoval na veľkých projektoch. Stavali sme ich na robustných frameworkoch a vo väčšine prípadov sme tiež napísali správne unit a integračné testy. Verím, že dobre napísané testy vám môžu ušetriť čas, ktorý by ste inak strávili ladením a inými aktivitami.
...
- [Príručku štýlov pre Arduino API][arduino-api-style-guide], ktorá je definuje pravidlá pre písania API knižníc
...
Potom, ako ste napísali high-level prehľad vašej knižnice, je čas napísať komentáre priamo do kódu. Rozhodol som sa použiť [Doxygen][doxygen]: ide o de facto štandard a je jednoduché ho nastaviť. Taktiež podporuje niekoľko štýlov komentárov, vrátane štýlu Javadoc.
...
Vygenerovanú dokumentáciu môžete umiestniť, kde len chcete. Ide o statickú HTML stránku bez externých závislostí. Ja mám dokumentáciu zadarmo na GitHub Pages. Pre inšpiráciu, [tu][objectbutton-doxygen] je vygenerovaná dokumentácia pre jeden z mojich projektov.
...
### Testované funkcie
Všetky vaše testy idú do priečinka `test`. Zvyčajne ich nazvete rovnako ako testovnú funkciu. ObjectButton by mal vedieť rozpoznať tri typy odlišných akcií.
...
Aj keď ste váš kód zdokumentovali a otestovali, stále ešte máte prácu. Nabudúce vám vysvetlím, ako automatizovať vývojový proces a nastaviť vo vašom repozitári priebežnú integráciu, aby sa po každom commite automaticky spustili testy a zostavila dokumentácia.
