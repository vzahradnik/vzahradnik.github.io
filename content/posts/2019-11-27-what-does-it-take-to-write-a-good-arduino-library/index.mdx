...
- [Arduino API Style Guide][arduino-api-style-guide], which is a style guide for writing library APIs
- [Arduino library specification][arduino-library-specification], which is a specification you should follow to make your library compatible with Arduino IDE
